...
namespace MageTips\WindowsAzure\ServiceBus\Internal;

use Exception;
use MageTips\WindowsAzure\Common\Internal\FilterableService;
...
interface IServiceBus extends FilterableService
{
    ...
    /**
     * Renews the lock on a peek-locked brokered message, extending its
     * LockedUntilUtc so a slow handler doesn't lose the lock mid-processing.
     *
     * @param BrokeredMessage $brokeredMessage The brokered message
     *
     * @throws Exception
