...
namespace MageTips\WindowsAzure\ServiceBus;
...
use MageTips\WindowsAzure\Common\Internal\ServiceRestProxy;
...
use MageTips\WindowsAzure\Common\Internal\Atom\Content;
use MageTips\WindowsAzure\Common\Internal\Atom\Entry;
use MageTips\WindowsAzure\ServiceBus\Internal\IServiceBus;
use MageTips\WindowsAzure\ServiceBus\Models\BrokeredMessage;
use MageTips\WindowsAzure\ServiceBus\Models\BrokerProperties;
use MageTips\WindowsAzure\ServiceBus\Models\ListQueuesOptions;
use MageTips\WindowsAzure\ServiceBus\Models\ListQueuesResult;
use MageTips\WindowsAzure\ServiceBus\Models\ListSubscriptionsOptions;
use MageTips\WindowsAzure\ServiceBus\Models\ListSubscriptionsResult;
use MageTips\WindowsAzure\ServiceBus\Models\ListTopicsOptions;
use MageTips\WindowsAzure\ServiceBus\Models\ListTopicsResult;
use MageTips\WindowsAzure\ServiceBus\Models\ListRulesOptions;
use MageTips\WindowsAzure\ServiceBus\Models\ListRulesResult;
use MageTips\WindowsAzure\ServiceBus\Models\ListOptions;
use MageTips\WindowsAzure\ServiceBus\Models\QueueInfo;
...
use MageTips\WindowsAzure\Common\Internal\Validate;
...
class ServiceBusRestProxy extends ServiceRestProxy implements IServiceBus
{
    ...
    /**
     * Renews the lock on a peek-locked brokered message.
     *
     * @link https://learn.microsoft.com/rest/api/servicebus/renew-lock
     *
     * @param BrokeredMessage $brokeredMessage The brokered message
     */
    public function renewLock(BrokeredMessage $brokeredMessage)
    {
        $httpCallContext = new HttpCallContext();
        $httpCallContext->setMethod(Resources::HTTP_POST);
        $lockLocation = $brokeredMessage->getLockLocation();
